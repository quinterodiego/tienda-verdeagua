...
// Iconos adicionales para el panel de admin
...
export const CheckCircleIcon2 = ({ className }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
  </svg>
);

export const XCircleIcon2 = ({ className }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
...
export const TruckIcon = ({ className }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m6.75 4.5v-3a1.5 1.5 0 0 0-3 0v3m3 0h9m-9-9v9m9-9a1.5 1.5 0 0 0-3 0v3.75a.75.75 0 0 1-.75.75h-9a.75.75 0 0 1-.75-.75V9.75M21 7.5V6a1.5 1.5 0 0 0-1.5-1.5H15m0 0v3.75M15 4.5v3.75m0-3.75H9.75a1.5 1.5 0 0 0-1.5 1.5v3.75m6.75-3.75v3.75m0 0H12" />
  </svg>
);
...
export const Trash2Icon = ({ className }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
...
// Iconos adicionales para checkout
...
export const BanknotesIcon = ({ className }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H15m-6.75 0V4.5c0-.827.673-1.5 1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v.75h.75a.75.75 0 0 1 .75.75v.75h.75a.75.75 0 0 1 .75.75v.375c0 .828-.672 1.5-1.5 1.5h-1.5A.75.75 0 0 1 12 7.5V6h-.75a.75.75 0 0 1-.75-.75V4.5Z" />
  </svg>
);
