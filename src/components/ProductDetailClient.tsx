    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">{error || 'El producto que buscas no existe o no está disponible.'}</p>
          <Link 
            href="/" 
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <button
            onClick={() => router.back()}
            className="flex items-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white mb-4 touch-manipulation"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            Volver
          </button>
          
          <nav className="text-sm text-gray-600 dark:text-gray-300 hidden sm:block">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="space-y-4 animate-fade-in">
            {/* Imagen principal */}
            <div className="relative aspect-square bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg group">
              <Image
              ...
              {productImages.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-800 text-gray-800 dark:text-white p-3 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110 shadow-lg"
                  >
                    <ArrowLeft className="w-5 h-5" />
                  </button>
                  <button
                    onClick={() => setSelectedImage(selectedImage < productImages.length - 1 ? selectedImage + 1 : 0)}
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm hover:bg-white dark:hover:bg-gray-800 text-gray-800 dark:text-white p-3 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110 shadow-lg rotate-180"
                  >
                    <ArrowLeft className="w-5 h-5" />
                  </button>
                </>
          ...
          <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            {/* Precio */}
            <div className="border-t border-b border-gray-200 dark:border-gray-700 py-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="flex items-center space-x-4">
                <span className="text-4xl font-bold text-gray-900 dark:text-white cursor-default">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.5s' }}>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">Descripción</h3>
            ...
            {((product as any).medidas || (product as any).color) && (
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg animate-fade-in transform transition-all duration-300 hover:scale-105 hover:shadow-md" style={{ animationDelay: '0.6s' }}>
                <h4 className="font-medium text-gray-900 dark:text-white mb-2">Especificaciones</h4>
            ...
            <div className="flex items-center space-x-2 animate-fade-in transform transition-all duration-300 hover:scale-105" style={{ animationDelay: '0.7s' }}>
              <span className="text-sm text-gray-600 dark:text-gray-300">Stock disponible:</span>
            ...
            {product.stock > 0 && (
              <div className="space-y-4 animate-fade-in" style={{ animationDelay: '0.8s' }}>
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
                    <button
                      onClick={decrementQuantity}
                      className="p-3 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 touch-manipulation transform hover:scale-110 disabled:opacity-50 disabled:transform-none"
                      disabled={quantity <= 1}
                    >
                      <Minus className="w-4 h-4" />
                    </button>
                    <span className="px-4 py-2 text-center min-w-[60px] text-lg font-semibold text-gray-900 dark:text-white">{quantity}</span>
                    <button
            ...
            <div className="flex space-x-4 pt-4 animate-fade-in" style={{ animationDelay: '0.9s' }}>
              ...
              <button className="flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-[#68c3b7] dark:hover:text-[#68c3b7] transition-all duration-300 transform hover:scale-105 hover:bg-gray-50 dark:hover:bg-gray-700 px-3 py-2 rounded-lg">
